...
@section("sidebar")
    <div class="border-end bg-white" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <x-navlink-component class="border mt-1" link="{{ route('unite.index') }}" icon="mdi-shield-home">
                Mon unite
            </x-navlink-component>
            {{-- si il est chef --}}
            @if (auth()->user()->chef)
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex align-items-baseline justify-content-between">
                                <span>Type de L'unite: </span><span class="p-2 border" style="font-weight: bolder">{{auth()->user()->getPersonnel()->unite->getTypeUniteName()}}</span>
                            </li>
                            <li class="list-group-item">
